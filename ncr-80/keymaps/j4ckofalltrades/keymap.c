/* Copyright 2022 Jordan Duabe <me@jduabe.dev>
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        MT(MOD_LCTL, KC_ESC), KC_LGUI,            KC_LALT,            KC_SPC,             KC_RALT,            MO(1),   KC_APP,  KC_RCTL,            KC_LEFT,   KC_DOWN,            KC_RGHT
    ),

    [1] = LAYOUT(
        RESET,   KC_MPRV, KC_MNXT, KC_MPLY, KC_MSTP, KC_VOLU, KC_VOLD, KC_MUTE, _______, _______, _______, _______, _______, _______, _______, _______,
        CG_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
