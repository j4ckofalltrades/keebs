...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_QWERTY] = LAYOUT_preonic_grid(
      ...
      KC_LCTL,              KC_LALT, KC_LGUI, KC_LGUI, FN_MO13, KC_SPC,  KC_SPC,  FN_MO23, KC_RGUI, KC_RGUI, KC_RALT, KC_RCTRL
    ),
    ...
    */
    [_RAISE] = LAYOUT_preonic_grid(
      ...
      KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, _______, KC_PGUP,  KC_PGDN, _______,
